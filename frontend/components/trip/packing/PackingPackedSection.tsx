...
import { PackingPackedItem } from "./PackingPackedItem"
import { PackingPackedCategory } from "./PackingPackedCategory"

interface PackingPackedSectionProps {
    tripId: number
    groups: CategoryViewModel[]
    uncategorizedItems: ItemViewModel[]
}

export function PackingPackedSection({ tripId, groups, uncategorizedItems }: PackingPackedSectionProps) {
