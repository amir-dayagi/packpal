...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-background via-background to-tertiary/30">
            {/* Hero Section */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
                    <div className="text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <Link
                                href="/signup"
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary to-primary-hover px-8 py-4 text-base font-semibold text-white shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-200 transform hover:scale-105"
                            >
                                Get Started
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-background/80 backdrop-blur-sm rounded-2xl p-8 border border-tertiary/50 shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <p className="text-secondary">
                            Get intelligent packing recommendations based on your destination, weather, and trip duration.
                        </p>
                    </div>
                    ...
                    <div className="bg-background/80 backdrop-blur-sm rounded-2xl p-8 border border-tertiary/50 shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <p className="text-secondary">
                            Keep track of all your items with our comprehensive checklist system. Mark items as packed and stay organized.
                        </p>
                    </div>
                    ...
                    <div className="bg-background/80 backdrop-blur-sm rounded-2xl p-8 border border-tertiary/50 shadow-lg hover:shadow-xl transition-shadow">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/20 to-primary-hover/20 flex items-center justify-center mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-6 h-6 text-primary">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M6 6.878V6a2.25 2.25 0 012.25-2.25h7.5A2.25 2.25 0 0118 6v.878m-12 0a2.25 2.25 0 00-1.5 2.122v6a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25V9a2.25 2.25 0 00-1.5-2.122M6 6.878l-3 1.5v9.744a2.25 2.25 0 002.25 2.25h13.5A2.25 2.25 0 0021 18.122V8.378l-3-1.5M6 6.878V4.5c0-1.036.84-1.875 1.875-1.875h8.25c1.036 0 1.875.84 1.875 1.875V6.878" />
                            </svg>
                        </div>
                        <h3 className="text-xl font-semibold text-foreground mb-2">
                            Trip Management
                        ...
                        <p className="text-secondary">
                            Organize multiple trips, save packing lists, and reuse them for future adventures.
                        </p>
                    </div>
                </div>
            </div>
