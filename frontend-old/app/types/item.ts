...
export interface MarkAsPackedRequest {
    itemId: number
    tripId: number
    origin: ItemOrigin
    quantity?: number
...
export interface UnmarkAsPackedRequest extends MarkAsPackedRequest { }

export interface MarkAsReturningRequest extends MarkAsPackedRequest { }

export interface UnmarkAsReturningRequest extends MarkAsPackedRequest { }
