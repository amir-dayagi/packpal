...
import { formatDate } from "@/app_old/utils/date";
...
export default function TripHeader() {
    ...
    const { trip, deleteTrip } = useTrip(tripId)
        ...
        <div className="card">
            <div className="flex items-start justify-between">
                ...
                <div className="flex gap-2 ml-4">
                    <GradientButton
                        onClick={() => openModal(CreateCategoryModal, { tripId })}
                    >
                        Create Category
                    </GradientButton>
                    <button
                        onClick={() => openModal(EditTripModal, { tripId })}
